          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: ElevatedButton(
                      ...
                      child: Text('🔄 Refresh Cart', style: TextStyle(fontFamily: baseFont)),
                    ),
                  ),
                  SizedBox(width: 8.w),
                  Expanded(
                    child: ElevatedButton(
                      ...
                      child: Text('🧹 Clean Duplicates', style: TextStyle(fontFamily: baseFont)),
                    ),
                  ),
                ],
              ),
              ...
              ElevatedButton(
                ...
                child: Text('🧪 Run Validation Tests', style: TextStyle(fontFamily: baseFont)),
              ),
